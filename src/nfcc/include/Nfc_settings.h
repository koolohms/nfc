 ...
 * Refer to NFC controller Hardware Design Guide document for more details
 */
/* TxLDO configuration related to 1st generation of NXP-NCI controller (e.g PN7120) */
uint8_t NxpNci_TVDD_CONF_1stGen[]={0x20, 0x02, 0x05, 0x01, 0xA0, 0x13, 0x01, 0x00};

/* TxLDO configuration related to 2nd generation of NXP-NCI controller (e.g PN7150)*/
/* and to 3rd generation of NXP-NCI controller (e.g PN7160)*/
 #if (NXP_TVDD_CONF == 1)
