...
enum
{
  DISK_BLOCK_NUM  = 200, // 8KB is the smallest size that windows allow to mount
  DISK_BLOCK_SIZE = 512
};
...
uint8_t msc_disk0[DISK_BLOCK_NUM][DISK_BLOCK_SIZE] =
{
  ...
  // FAT partition boot sector code at offset 510-511
  {
      0xEB, 0x3C, 0x90, 0x4D, 0x53, 0x44, 0x4F, 0x53, 0x35, 0x2E, 0x30, 0x00, 0x02, 0x01, 0x01, 0x00,
      0x01, 0x10, 0x00, 0xC8, 0x00, 0xF8, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x29, 0x34, 0x12, 0x00, 0x00, 'w' , 'a' , 'v' , 'e' , ' ' ,
  ...
  //------------- Block2: Root Directory -------------//
  {
      ...
      'w' , 'a' , 'v' , 'e' , ' ' , ' ' , ' ' , ' ' , ' ' , ' ' , ' ' , 0x08, 0x00, 0x00, 0x00, 0x00,
